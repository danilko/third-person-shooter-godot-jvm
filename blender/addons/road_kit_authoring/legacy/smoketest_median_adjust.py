...
RUN: blender --background --python-exit-code 1 --python addons/road_kit_authoring/smoketest_median_adjust.py
"""
import bpy
import os
import sys
...
def main():
    ...
    r0 = spine_io.points(spine)[0].radius
    ...
    spine = bpy.data.objects.get(coll["rka_curve_object"])
    r1 = spine_io.points(spine)[0].radius
