#!/usr/bin/env python3
"""build_district_test_b.py -> assets/world_source/pieces/District_test_7_8.blend
...
BP = os.path.dirname(HERE)                        # blender
WORLD_SOURCE = os.path.join(os.path.dirname(BP), "assets", "world_source")
...
OUT = os.path.join(WORLD_SOURCE, "pieces", "District_test_7_8.blend")
