...
real per-district geometry hand-authored in each piece's own .blend.

Each district .blend is authored at ORIGIN (spans [-half,+half]) — this script appends each
one's STREET collection into one working scene and
...
Example (the Shibuya / (2,1) / (1,2) cluster):
  blender --background --python tools/render_cluster.py -- _preview_cluster \\
      pieces/Piece_1_1.blend:1:1 \\
      pieces/Piece_2_1.blend:2:1 \\
      pieces/Piece_1_2.blend:1:2
"""
import bpy, os, sys
