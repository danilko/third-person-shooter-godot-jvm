 ...
 *   RigidBody3D + FRG1Projectile script
 *     CollisionShape3D   (layer 3 / mask world(1); CCD enabled)
 *     MeshInstance3D     (optional visible mesh)
 */
@Script(className = "FRG1Projectile")
public class FRG1Projectile extends RigidBody3D implements Detonatable, CosmeticProjectile {
