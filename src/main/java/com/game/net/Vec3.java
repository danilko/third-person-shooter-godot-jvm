 ...
 * import) so every class in {@code com.game.net} can be unit-tested headless without the
 * Godot runtime, which can't instantiate native types like {@code StreamPeerBuffer} or
 * {@code CharacterBody3D}.
 *
 * The Godot adapters ({@link com.character.NetworkController}, {@link com.character.PlayerController})
