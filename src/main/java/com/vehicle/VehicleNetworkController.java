...
import com.game.NetMessageCodec.DecodedVehicleSnapshot;
import com.game.net.Quat;
import com.game.net.RigidSnapshotInterpolator;
import com.game.net.TimestampUnwrapper;
import com.game.net.Vec3;
 ...
 * counterpart of {@link com.character.NetworkController}. Attached/removed by
...
public class VehicleNetworkController extends Controller {
    ...
    private void applyDiscreteState(DecodedVehicleSnapshot snap, boolean applyHealth) {
        ...
        if (applyHealth) {
            ...
            if (healthNode instanceof com.character.Health health) {
